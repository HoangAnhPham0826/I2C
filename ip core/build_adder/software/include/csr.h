...
#define CSR_ADDER_IN1_ADDR (CSR_BASE + 0x0L)
#define CSR_ADDER_IN1_SIZE 1
#define CSR_ADDER_IN2_ADDR (CSR_BASE + 0x4L)
#define CSR_ADDER_IN2_SIZE 1
...
#define CSR_DDRPHY_RST_ADDR (CSR_BASE + 0x2000L)
#define CSR_DDRPHY_RST_SIZE 1
#define CSR_DDRPHY_DLY_SEL_ADDR (CSR_BASE + 0x2004L)
#define CSR_DDRPHY_DLY_SEL_SIZE 1
#define CSR_DDRPHY_HALF_SYS8X_TAPS_ADDR (CSR_BASE + 0x2008L)
#define CSR_DDRPHY_HALF_SYS8X_TAPS_SIZE 1
#define CSR_DDRPHY_WLEVEL_EN_ADDR (CSR_BASE + 0x200cL)
#define CSR_DDRPHY_WLEVEL_EN_SIZE 1
#define CSR_DDRPHY_WLEVEL_STROBE_ADDR (CSR_BASE + 0x2010L)
#define CSR_DDRPHY_WLEVEL_STROBE_SIZE 1
#define CSR_DDRPHY_CDLY_RST_ADDR (CSR_BASE + 0x2014L)
#define CSR_DDRPHY_CDLY_RST_SIZE 1
#define CSR_DDRPHY_CDLY_INC_ADDR (CSR_BASE + 0x2018L)
#define CSR_DDRPHY_CDLY_INC_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_RST_ADDR (CSR_BASE + 0x201cL)
#define CSR_DDRPHY_RDLY_DQ_RST_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_INC_ADDR (CSR_BASE + 0x2020L)
#define CSR_DDRPHY_RDLY_DQ_INC_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_RST_ADDR (CSR_BASE + 0x2024L)
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_RST_SIZE 1
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_ADDR (CSR_BASE + 0x2028L)
#define CSR_DDRPHY_RDLY_DQ_BITSLIP_SIZE 1
#define CSR_DDRPHY_WDLY_DQ_RST_ADDR (CSR_BASE + 0x202cL)
#define CSR_DDRPHY_WDLY_DQ_RST_SIZE 1
#define CSR_DDRPHY_WDLY_DQ_INC_ADDR (CSR_BASE + 0x2030L)
#define CSR_DDRPHY_WDLY_DQ_INC_SIZE 1
#define CSR_DDRPHY_WDLY_DQS_RST_ADDR (CSR_BASE + 0x2034L)
#define CSR_DDRPHY_WDLY_DQS_RST_SIZE 1
#define CSR_DDRPHY_WDLY_DQS_INC_ADDR (CSR_BASE + 0x2038L)
#define CSR_DDRPHY_WDLY_DQS_INC_SIZE 1
#define CSR_DDRPHY_WDLY_DQ_BITSLIP_RST_ADDR (CSR_BASE + 0x203cL)
#define CSR_DDRPHY_WDLY_DQ_BITSLIP_RST_SIZE 1
#define CSR_DDRPHY_WDLY_DQ_BITSLIP_ADDR (CSR_BASE + 0x2040L)
#define CSR_DDRPHY_WDLY_DQ_BITSLIP_SIZE 1
#define CSR_DDRPHY_RDPHASE_ADDR (CSR_BASE + 0x2044L)
#define CSR_DDRPHY_RDPHASE_SIZE 1
#define CSR_DDRPHY_WRPHASE_ADDR (CSR_BASE + 0x2048L)
...
#define CSR_SDRAM_DFII_PI0_RDDATA_ADDR (CSR_BASE + 0x601cL)
#define CSR_SDRAM_DFII_PI0_RDDATA_SIZE 2
#define CSR_SDRAM_DFII_PI1_COMMAND_ADDR (CSR_BASE + 0x6024L)
#define CSR_SDRAM_DFII_PI1_COMMAND_SIZE 1
#define CSR_SDRAM_DFII_PI1_COMMAND_ISSUE_ADDR (CSR_BASE + 0x6028L)
#define CSR_SDRAM_DFII_PI1_COMMAND_ISSUE_SIZE 1
#define CSR_SDRAM_DFII_PI1_ADDRESS_ADDR (CSR_BASE + 0x602cL)
#define CSR_SDRAM_DFII_PI1_ADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI1_BADDRESS_ADDR (CSR_BASE + 0x6030L)
#define CSR_SDRAM_DFII_PI1_BADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI1_WRDATA_ADDR (CSR_BASE + 0x6034L)
#define CSR_SDRAM_DFII_PI1_WRDATA_SIZE 2
#define CSR_SDRAM_DFII_PI1_RDDATA_ADDR (CSR_BASE + 0x603cL)
#define CSR_SDRAM_DFII_PI1_RDDATA_SIZE 2
#define CSR_SDRAM_DFII_PI2_COMMAND_ADDR (CSR_BASE + 0x6044L)
#define CSR_SDRAM_DFII_PI2_COMMAND_SIZE 1
#define CSR_SDRAM_DFII_PI2_COMMAND_ISSUE_ADDR (CSR_BASE + 0x6048L)
#define CSR_SDRAM_DFII_PI2_COMMAND_ISSUE_SIZE 1
#define CSR_SDRAM_DFII_PI2_ADDRESS_ADDR (CSR_BASE + 0x604cL)
#define CSR_SDRAM_DFII_PI2_ADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI2_BADDRESS_ADDR (CSR_BASE + 0x6050L)
#define CSR_SDRAM_DFII_PI2_BADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI2_WRDATA_ADDR (CSR_BASE + 0x6054L)
#define CSR_SDRAM_DFII_PI2_WRDATA_SIZE 2
#define CSR_SDRAM_DFII_PI2_RDDATA_ADDR (CSR_BASE + 0x605cL)
#define CSR_SDRAM_DFII_PI2_RDDATA_SIZE 2
#define CSR_SDRAM_DFII_PI3_COMMAND_ADDR (CSR_BASE + 0x6064L)
#define CSR_SDRAM_DFII_PI3_COMMAND_SIZE 1
#define CSR_SDRAM_DFII_PI3_COMMAND_ISSUE_ADDR (CSR_BASE + 0x6068L)
#define CSR_SDRAM_DFII_PI3_COMMAND_ISSUE_SIZE 1
#define CSR_SDRAM_DFII_PI3_ADDRESS_ADDR (CSR_BASE + 0x606cL)
#define CSR_SDRAM_DFII_PI3_ADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI3_BADDRESS_ADDR (CSR_BASE + 0x6070L)
#define CSR_SDRAM_DFII_PI3_BADDRESS_SIZE 1
#define CSR_SDRAM_DFII_PI3_WRDATA_ADDR (CSR_BASE + 0x6074L)
#define CSR_SDRAM_DFII_PI3_WRDATA_SIZE 2
#define CSR_SDRAM_DFII_PI3_RDDATA_ADDR (CSR_BASE + 0x607cL)
...
static inline uint32_t adder_in1_read(void) {
	return csr_read_simple((CSR_BASE + 0x0L));
}
static inline void adder_in1_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x0L));
}
static inline uint32_t adder_in2_read(void) {
	return csr_read_simple((CSR_BASE + 0x4L));
}
static inline void adder_in2_write(uint32_t v) {
...
static inline uint64_t sdram_dfii_pi0_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x6014L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6018L));
	return r;
}
static inline void sdram_dfii_pi0_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x6014L));
	csr_write_simple(v, (CSR_BASE + 0x6018L));
}
static inline uint64_t sdram_dfii_pi0_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x601cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6020L));
	return r;
}
...
static inline uint64_t sdram_dfii_pi1_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x6034L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6038L));
	return r;
}
static inline void sdram_dfii_pi1_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x6034L));
	csr_write_simple(v, (CSR_BASE + 0x6038L));
}
static inline uint64_t sdram_dfii_pi1_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x603cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6040L));
	return r;
}
...
static inline uint64_t sdram_dfii_pi2_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x6054L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6058L));
	return r;
}
static inline void sdram_dfii_pi2_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x6054L));
	csr_write_simple(v, (CSR_BASE + 0x6058L));
}
static inline uint64_t sdram_dfii_pi2_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x605cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6060L));
	return r;
}
...
static inline uint64_t sdram_dfii_pi3_wrdata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x6074L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6078L));
	return r;
}
static inline void sdram_dfii_pi3_wrdata_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x6074L));
	csr_write_simple(v, (CSR_BASE + 0x6078L));
}
static inline uint64_t sdram_dfii_pi3_rddata_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x607cL));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x6080L));
	return r;
}
