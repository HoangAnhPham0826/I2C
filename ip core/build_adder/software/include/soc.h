...
#define CONFIG_PLATFORM_NAME "xilinx_vc707"
...
#define CONFIG_IDENTIFIER "LiteX SoC on VC707"
...
static inline int sdcard_irq_interrupt_read(void) {
	return 3;
}
